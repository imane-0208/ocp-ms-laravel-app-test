...
@section('content')
                                ...
                                <div class="d-flex flex-start">
                                    ...
                                    <div class="d-flex flex-end ms-auto">
                                        @if ($post->user->id == Auth::user()->id)
                                            ...
                                            <a href="#!" class="btn text-success p-2"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="20" height="20"
            ...
            <div class="bg-light p-2">
                <form action="{{ route('comment.store') }}" method="post">
                    ...
                    <button class="text-end mt-3 btn btn-primary btn-sm shadow-none" type="submit">Post comment  <span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-send" viewBox="0 0 16 16">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <form action="{{ route('reply.store') }}" method="post">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <button class="btn btn-primary btn-sm shadow-none" type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-send" viewBox="0 0 16 16">
                                                <path d="M15.854.146a.5.5 0 0 1 .11.54l-5.819 14.547a.75.75 0 0 1-1.329.124l-3.178-4.995L.643 7.184a.75.75 0 0 1 .124-1.33L15.314.037a.5.5 0 0 1 .54.11ZM6.636 10.07l2.761 4.338L14.13 2.576 6.636 10.07Zm6.787-8.201L1.591 6.602l4.339 2.76 7.494-7.493Z"/>
                                              </svg></button>
                                        </div>
                                        <input type="hidden" name="user_id" value="{{ Auth::user()->id }}">
                                        ...
                                        <div class="d-flex  align-items-center">
                                            <p class="small mb-0" style="color: #aaa;">
                                                @if ($reply->user->id == Auth::user()->id)
                                                    <form action="{{ route('reply.delete', $reply->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
